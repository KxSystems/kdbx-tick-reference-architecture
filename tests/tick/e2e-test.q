...
apiCmd:"q tests/api-test.q -gwPort ",string[GW_PORT]," -procName api-test";
...
restCmd:"q tests/rest-test.q -gwPort ",string[GW_PORT]," 2>&1";
.log.info["Running: q tests/rest-test.q -gwPort ",string GW_PORT];
...
if[not null fhPidI;
    ...
    system "kill -9 ",fhPid;
    system "sleep 0.5";
    system "./scripts/tick/monitor.sh -e .env -m 1";
    system "sleep 2";
...
if[not null gwPidI;
    ...
    system "kill -9 ",gwPid;
    system "sleep 0.5";
    system "./scripts/tick/restart.sh GW -e .env -m 1";
    system "sleep 3";
