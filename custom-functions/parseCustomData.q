...
//Upsert data to TP
.upsert.data:{[]
        neg[TP_H](".u.upd";`energy;value flip (select from .parse.energy["KwhConsumptionBlower78_1.csv"])); 
        neg[TP_H](".u.upd";`weather;value flip (select from .parse.weather["weather_data.csv"]));
    };
