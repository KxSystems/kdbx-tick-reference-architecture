// tick-x/src/hdb.q - Historical Database Process
//
...
//
// q tick-x/src/hdb.q -p $HDB_PORT -hdbDir $HDB_DIR -procName HDB
...
// exists (mirrors idb.q). Loaded BEFORE mounting the db so real partitions override these
// empty in-memory tables once they are written.
{[x]
