...
calcHeatIndex:{[temp;humidity]
    ...
    hiF: (c[1]) + (c[2]*temp) + (c[3]*humidity) + (c[4]*temp*humidity) + (c[5]*temp*temp) + (c[6]*humidity*humidity) + (c[7]*temp*temp*humidity) + (c[8]*temp*humidity*humidity) + (c[9]*temp*temp*humidity*humidity);
