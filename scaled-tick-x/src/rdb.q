// scaled-tick-x/src/rdb.q - Realtime Database
//
...
//
// q scaled-tick-x/src/rdb.q -p $RDB_PORT       -tpPort $TICK_PORT -hdbPort $HDB_PORTS \
//                     -idbPort $IDB_PORT -idbDir $IDB_DIR -flushIntvMin $FLUSH_INTV_MIN \
//                     -tplogDir $TPLOG_DIR -hdbDir $HDB_DIR -procName RDB
// q scaled-tick-x/src/rdb.q -p $RDB_CHAIN_PORT -tpPort $TICK_PORT -hdbPort $HDB_PORTS \
//                     -idbPort $IDB_PORT -idbDir $IDB_DIR -flushIntvMin $FLUSH_INTV_MIN \
