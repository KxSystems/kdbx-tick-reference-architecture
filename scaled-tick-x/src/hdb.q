// scaled-tick-x/src/hdb.q - Historical Database
//
...
//
// q scaled-tick-x/src/hdb.q -p $HDB_PORT -hdbDir $HDB_DIR -procName HDB
// q scaled-tick-x/src/hdb.q -p $HDB_EXTRA_PORT -hdbDir $HDB_DIR -procName HDB_EXTRA_<N>
